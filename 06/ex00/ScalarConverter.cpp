...
/*   Updated: 2025/04/16 13:09:40 by zserobia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*std::fixed:
Этот манипулятор изменяет формат вывода чисел с плавающей запятой, заставляя их выводиться в 
фиксированном формате. Это означает, что число будет выводиться с запятой, а не в экспоненциальной
 форме (например, 1.23e+2 будет выведено как 123.0).
